...
\author{
    ...
    \thanks{Kjell~Erlandsson and Kris~Thielemans are with the Institute of Nuclear Medicine, University College London, UK.}
    \thanks{Ander~Biguri was with the Institute of Nuclear Medicine, University College London, UK. He is now with the Department of Applied Mathematics and Theoretical Physics, University of Cambridge, UK}
    \thanks{Scott~D.~Wollenweber is with Molecular Imaging and Computed Tomography Engineering, GE Healthcare, USA}
